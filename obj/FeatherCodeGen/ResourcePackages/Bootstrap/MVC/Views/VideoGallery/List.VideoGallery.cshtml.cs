...
WriteAttribute("class", Tuple.Create(" class=\"", 346), Tuple.Create("\"", 421)
            
            #line 11 "..\..MVC\Views\VideoGallery\List.VideoGallery.cshtml"
, Tuple.Create(Tuple.Create("", 354), Tuple.Create<System.Object, System.Int32>(Model.CssClass
            
            #line default
            #line hidden
, 354), false)
, Tuple.Create(Tuple.Create(" ", 369), Tuple.Create("sf-Gallery-thumbs", 370), true)
, Tuple.Create(Tuple.Create(" ", 387), Tuple.Create("sf-Gallery-thumbs--video", 388), true)
, Tuple.Create(Tuple.Create(" ", 412), Tuple.Create("clearfix", 413), true)
);
...
WriteAttribute("src", Tuple.Create(" src=\"", 1151), Tuple.Create("\"", 1204)
            
            #line 23 "..\..MVC\Views\VideoGallery\List.VideoGallery.cshtml"
, Tuple.Create(Tuple.Create("", 1157), Tuple.Create<System.Object, System.Int32>(((VideoThumbnailViewModel)item).ThumbnailUrl
...
WriteAttribute("alt", Tuple.Create(" alt=\'", 1205), Tuple.Create("\'", 1293)
            
            #line 23 "..\..MVC\Views\VideoGallery\List.VideoGallery.cshtml"
    , Tuple.Create(Tuple.Create("", 1211), Tuple.Create<System.Object, System.Int32>(System.Text.RegularExpressions.Regex.Replace(item.Fields.Title, @"[^\w\d_-]", "")
